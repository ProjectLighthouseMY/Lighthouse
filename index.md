...
<section class="hero-shell">
  <div class="hero-image" aria-hidden="true"></div><div class="hero-overlay"></div>
...
<section class="page-width split-section">
  ...
  <div class="panel"><p class="section-label">Operating Principles</p><span class="small-rule"></span>
    <div class="principle"><img src="{{ '/assets/icons/user.svg' | relative_url }}" alt=""><div><h3>Authorised</h3><p>We only test systems and applications we are explicitly authorised to assess.</p></div></div>
